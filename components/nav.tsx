"use client";
// components/nav.tsx — v4 FINAL
// FIX: Bỏ <style> inject (gây nav stretch) → dùng inline style hoàn toàn
// FIX: Grid layout không dùng position:absolute
    ...
    <nav style={{
      ...
      <Link href="/" style={{
        ...
        <span style={{
          ...
          Shelby{" "}
          <span style={{ color: "#059669", fontWeight: 500 }}>Analytics</span>
        </span>
      </Link>
      ...
      <div style={{
        ...
        overflow: "hidden",
        // Giới hạn chiều rộng để không bị stretch
      ...
      <div style={{
        ...
        <div style={{
          display: "flex", gap: 2,
          background: "#F4F4F4", borderRadius: 10, padding: 3,
        }}>
