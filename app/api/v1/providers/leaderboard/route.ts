// app/api/v1/providers/leaderboard/route.ts
// Proxies to backend GET /api/v1/providers/leaderboard?network=&sort=&limit=
...
export async function GET(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    upstream = await fetch(`${VPS_URL}/api/v1/providers/leaderboard?${qs}`, {
      next: { revalidate: 0 },
    });
  } catch {
